...
namespace STP.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var sTPContext = _context.Employees.Include(e => e.Office);
        ...
        {
            ViewData["OfficeId"] = new SelectList(_context.Offices, "Id", "City");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,StartingDate,Salary,VacationDays,Experience,OfficeId")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
